"""from https://github.com/Strilanc/midout/blob/main/src/midout/gen/_noise.py"""

import collections
from typing import (AbstractSet, Any, DefaultDict, Dict, Iterator, List,
                    Optional, Set, Union)

import stim

__all__ = ['NoiseRule','NoiseModel']
    ...
    def uniform_depolarizing(p: float) -> 'NoiseModel':
        ...
        return NoiseModel(
            ...
            gate_rules={
                ...
                'MR': NoiseRule(after={'X_ERROR': p}),
                'MRX': NoiseRule(after={'Z_ERROR': p}),
                'MRZ': NoiseRule(after={'X_ERROR': p}),
            }
        )
